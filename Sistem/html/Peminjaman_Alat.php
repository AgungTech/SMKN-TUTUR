	...
	<div class="FORM_INVENTARIS">
		<form class="FORM_INPUT KIRI">
			...
			<div id="QR_BARANG" class="FORM_BAWAH">
				<canvas id="qr-canvas" width="185" height="185"></canvas>
				<div>
					<select id="cameraId"></select>
				 	<input id="save" type="button" value="Save"/>
					<input id="play" type="button" value="Play"/>
					<input id="stop" type="button" value="Pause"/>
					<input id="stopAll" type="button" value="Stop"/>
				</div>
				<div class="well">
					<label id="zoom-value" width="100">Zoom: 2</label>
					<input type="range" id="zoom" value="20" min="10" max="30"/>
					<label id="brightness-value" width="100">Brightness: 0</label>
					<input type="range" id="brightness" value="0" min="0" max="128"/>
					<label id="contrast-value" width="100">Contrast: 0</label>
					<input type="range" id="contrast" value="0" min="0" max="64"/>
					<label id="threshold-value" width="100">Threshold: 0</label>
					<input type="range" id="threshold" value="0" min="0" max="512"/>
					<label id="sharpness-value" width="100">Sharpness: off</label>
					<input type="checkbox" id="sharpness"/>
					<label id="grayscale-value" width="100">Grayscale: off</label>
					<input type="checkbox" id="grayscale"/>
				</div>
				<img id="scanned-img" width="185" height="185"/>
				<p id="scanned-QR"></p>
  			</div>
		</form>
